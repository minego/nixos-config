# Based on https://raw.githubusercontent.com/NixOS/nixpkgs/nixos-unstable/nixos/modules/programs/starship.nix
# but modified to work with my setup to provide the bits that are missing in
# nix-darwin
